...
![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/customSymbols.gif)

- **multi symbol matching**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/multiSymbolMatching.gif)

- **multi cursor support**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/multiline.gif)

- **highlight only the enclosing symbols**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/ignoreContent.gif)

- **change the color of highlighted text**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/textColor.gif)

- **bold text with increased letter spacing**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/bold.gif)

- **red border around text**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/border.gif)

- **underlined text**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/underline.gif)

- **changed background color**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/background.gif)

- **blurred out text**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/blur.gif)

- **separate highlighting of symbols and content**

![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/separateHighlighting.gif)
...
![](https://github.com/Durzn/BracketHighlighter/raw/HEAD/assets/hotkeyActions.gif)
